...
import { adjustDate } from '@backoffice/utils';

export const DYNAMIC_VARIABLE_MAP: Record<string, string> = {
	$CURRENT_USER: 'backoffice_users',
	$CURRENT_ROLE: 'backoffice_roles',
	$CURRENT_ROLES: 'backoffice_roles',
	$CURRENT_POLICIES: 'backoffice_policies',
};
