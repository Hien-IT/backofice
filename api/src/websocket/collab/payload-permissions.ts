...
import type { Accountability, PrimaryKey, SchemaOverview } from '@backoffice/types';
import { deepMapWithSchema, isDetailedUpdateSyntax } from '@backoffice/utils';
	...
	return deepMapWithSchema(
		...
		},
		{
			...
			onUnknownField: (entry) => {
				...
				// Allow Backoffice internal metadata keys like $type
