...
import { InvalidProviderConfigError, TokenExpiredError } from '@backoffice/errors';
import type { Accountability } from '@backoffice/types';
import { WebSocketMessage } from '@backoffice/types';
...
export default abstract class SocketController {
	...
	private catchInvalidMessages(ws: WebSocket) {
		 ...
		 * https://github.com/backoffice/backoffice/security/advisories/GHSA-hmgw-9jrg-hf2m
