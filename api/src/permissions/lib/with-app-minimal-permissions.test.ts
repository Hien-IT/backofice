import type { Accountability, Permission, Query } from '@backoffice/types';
...
vi.mock('@backoffice/system-data', () => ({ appAccessMinimalPermissions: mocks.appAccessMinimalPermissions }));
