import type { LogicalFilterAND, LogicalFilterOR, Permission } from '@backoffice/types';
import { flatten, isEqual, merge, omit } from 'lodash-es';
import { mergeFields } from './merge-fields.js';

// Adapted from https://github.com/backoffice/backoffice/blob/141b8adbf4dd8e06530a7929f34e3fc68a522053/api/src/utils/merge-permissions.ts#L4
/**
