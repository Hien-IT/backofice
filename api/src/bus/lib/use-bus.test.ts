...
import { type BusLocal, type BusRedis, createBus } from '@backoffice/memory';
...
beforeEach(() => {
	...
	vi.mocked(useEnv).mockReturnValue({ REDIS_BUS_NAMESPACE: 'backoffice:bus' } as any);
});
