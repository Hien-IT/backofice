...
import type { Snapshot, SnapshotDiff, SnapshotField, SnapshotRelation, SnapshotSystemField } from '@backoffice/types';
import type { ApiCollection } from '@backoffice/types';
import { DiffKind } from '@backoffice/types';
...
describe('apply command', () => {
	...
	describe('apply function', () => {
		...
		test('should error if Backoffice is not installed', async () => {
			...
			expect(mockLogger.error).toHaveBeenCalledWith(
				expect.stringContaining("Backoffice isn't installed on this database"),
			);
