...
import { createKv, type KvLocal, type KvRedis } from '@backoffice/memory';
...
describe('useCounters', () => {
	...
	beforeEach(() => {
		...
		vi.mocked(useEnv).mockReturnValue({ REDIS_COUNTERS_NAMESPACE: 'backoffice:counters' } as any);
	});
