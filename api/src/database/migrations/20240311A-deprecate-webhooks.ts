...
// To avoid typos
const TABLE_WEBHOOKS = 'backoffice_webhooks';
const TABLE_FLOWS = 'backoffice_flows';
const TABLE_OPERATIONS = 'backoffice_operations';
