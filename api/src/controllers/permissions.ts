import { ErrorCode, ForbiddenError, isBackofficeError } from '@backoffice/errors';
...
router.use(useCollection('backoffice_permissions'));
...
const readHandler = asyncHandler(async (req, res, next) => {
	...
	// temporary fix for missing permissions https://github.com/backoffice/backoffice/issues/18654
	...
	const meta = await metaService.getMetaForQuery('backoffice_permissions', temporaryQuery);
