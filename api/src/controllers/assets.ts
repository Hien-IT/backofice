...
import { InvalidPayloadError, InvalidQueryError, RangeNotSatisfiableError } from '@backoffice/errors';
import type { Range, TransformationFormat, TransformationParams } from '@backoffice/types';
import { TransformationMethods } from '@backoffice/types';
import { getDateTimeFormatted, parseJSON } from '@backoffice/utils';
...
router.use(useCollection('backoffice_files'));
...
router.get(
	...
	asyncHandler(async (req, res, next) => {
		const payloadService = new PayloadService('backoffice_settings', { schema: req.schema });
