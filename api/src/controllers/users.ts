...
import type { PrimaryKey, RegisterUserInput } from '@backoffice/types';
...
router.use(useCollection('backoffice_users'));
...
const readHandler = asyncHandler(async (req, res, next) => {
	...
	const meta = await metaService.getMetaForQuery('backoffice_users', req.sanitizedQuery);
