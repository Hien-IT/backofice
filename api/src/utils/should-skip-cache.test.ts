...
test.each([
	...
	({ publicURL, refererHost }) => {
		vi.mocked(useEnv).mockReturnValue({
			...
			CACHE_AUTO_PURGE_IGNORE_LIST: ['backoffice_activity', 'backoffice_presets'],
		});
...
test.each([
	...
	({ publicURL, refererHost }) => {
		vi.mocked(useEnv).mockReturnValue({
			...
			CACHE_AUTO_PURGE_IGNORE_LIST: ['backoffice_activity', 'backoffice_presets', 'ignore_collection'],
		});
