import { GENERATE_SPECIAL, RELATIONAL_TYPES, TRANSLATIONS_STRIPPED_ON_CLONE_SPECIALS } from '@backoffice/constants';
import { InvalidPayloadError } from '@backoffice/errors';
import type { Field, RawField } from '@backoffice/types';
