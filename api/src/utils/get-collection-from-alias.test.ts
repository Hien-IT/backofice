...
it('Returns the correct collection', () => {
	const aliasMap: AliasMap = {
		author: { alias: 'aaaaa', collection: 'backoffice_users' },
		'author.role': { alias: 'bbbbb', collection: 'backoffice_roles' },
		'author.role.org': { alias: 'ccccc', collection: 'organisation' },
		'author.role.org.admin': { alias: 'ddddd', collection: 'backoffice_users' },
	};
