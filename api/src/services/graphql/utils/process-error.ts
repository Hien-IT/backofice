import { type BackofficeError, isBackofficeError } from '@backoffice/errors';
...
const processError = (
	...
	error: Readonly<GraphQLError & { originalError: GraphQLError | BackofficeError | Error | undefined }>,
	...
	if (isBackofficeError(originalError)) {
		return {
