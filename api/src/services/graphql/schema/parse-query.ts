import type { Accountability, Query, SchemaOverview } from '@backoffice/types';
import { getRelationInfo } from '@backoffice/utils';
...
/**
 * Get a Backoffice Query object from the parsed arguments (rawQuery) and GraphQL AST selectionSet. Converts SelectionSet into
 * Backoffice' `fields` query for use in the resolver. Also applies variables where appropriate.
 */
