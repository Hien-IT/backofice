 ...
 * whole nested tree into one big query using Backoffice' own query resolver, we want to have a nested structure of
 * arguments for the whole resolving tree, which can later be transformed into Backoffice' AST using `deep`.
