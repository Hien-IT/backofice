import { GENERATE_SPECIAL } from '@backoffice/constants';
import type { GQLScope } from '@backoffice/types';
			...
			fields: Object.values(collection.fields).reduce(
				(acc, field) => {
					...
					if (collection.primary === field.field && fieldIsInconsistent === false) {
						// permissions IDs need to be nullable https://github.com/backoffice/backoffice/issues/20509
						if (collection.collection === 'backoffice_permissions') {
							type = GraphQLID;
