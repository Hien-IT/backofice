...
import type { Accountability, GraphQLParams } from '@backoffice/types';
...
import isBackofficeJWT from '../../../utils/is-backoffice-jwt.js';
		...
		auth_password_request: {
			...
			resolve: async (_, args, { req }) => {
				...
				try {
					...
					if (isBackofficeError(err, ErrorCode.InvalidPayload)) {
						throw err;
					}
				}
