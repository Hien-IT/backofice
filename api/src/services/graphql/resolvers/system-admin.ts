...
import type { GraphQLParams } from '@backoffice/types';
	...
	const Extension = schemaComposer.createObjectTC({
		...
		fields: {
			...
			schema: schemaComposer.createObjectTC({
				name: 'backoffice_extensions_schema',
				fields: {
					type: GraphQLString,
			...
			meta: schemaComposer.createObjectTC({
				name: 'backoffice_extensions_meta',
				fields: {
			...
			args: {
				...
				data: toInputObjectType(
					schemaComposer.createObjectTC({
						name: 'update_backoffice_extensions_input',
						fields: {
							meta: schemaComposer.createObjectTC({
								name: 'update_backoffice_extensions_input_meta',
								fields: {
									enabled: GraphQLBoolean,
								},
							}),
