...
import { ForbiddenError, InvalidPayloadError, UnprocessableContentError } from '@backoffice/errors';
import type {
...
import { deepMapWithSchema } from '@backoffice/utils';
import Joi from 'joi';
...
export class VersionsService extends ItemsService<ContentVersion> {
	constructor(options: AbstractServiceOptions) {
		super('backoffice_versions', options);
	}
