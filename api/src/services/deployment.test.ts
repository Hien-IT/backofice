...
const schema = new SchemaBuilder()
	.collection('backoffice_deployments', (c) => {
...
describe('DeploymentService', () => {
	...
	describe('updateOne', () => {
		...
		beforeEach(() => {
			...
			tracker.on.select('backoffice_deployments').response([existingConfig]);
		});
	...
	describe('getDashboard / syncProjectMetadataIfStale', () => {
		...
		beforeEach(() => {
			...
			tracker.on.select('backoffice_deployments').response([deployment]);
		});
