...
import type { AbstractServiceOptions, Accountability, Comment, MutationOptions, PrimaryKey } from '@backoffice/types';
...
export class CommentsService extends ItemsService {
	...
	constructor(options: AbstractServiceOptions) {
		super('backoffice_comments', options);
...
`;
				...
				if (isBackofficeError(err, ErrorCode.Forbidden)) {
