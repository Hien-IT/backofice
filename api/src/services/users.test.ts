...
import type { Accountability, MutationOptions } from '@backoffice/types';
	...
	describe('Services / Users', () => {
		...
		describe('requestPasswordReset', () => {
			it('should throw ForbiddenError for external provider users', async () => {
				tracker.on.select('backoffice_users').response({
					id: 'user-id-ext',
					role: 'role-id',
					status: 'active',
					password: 'hashed',
