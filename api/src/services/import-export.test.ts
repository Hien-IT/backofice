...
import { ErrorCode, ForbiddenError } from '@backoffice/errors';
...
describe('ImportService', () => {
	...
	describe('import', () => {
		test('throws ForbiddenError for system collection when not admin', async () => {
			...
			await expect(importService.import('backoffice_users', 'text/csv', stream)).rejects.toThrow(ForbiddenError);
		});
