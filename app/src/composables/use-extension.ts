import type { AppExtensionConfigs, AppExtensionType, HybridExtensionType } from '@backoffice/types';
import type { Plural } from '@backoffice/types';
import { pluralize } from '@backoffice/utils';
