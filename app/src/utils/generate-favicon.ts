...
const svg = (color: string, addBackofficeLogo: boolean) => `
...
export const generateFavicon = (color: string, addBackofficeLogo = true) => {
	color = color || cssVar('--theme--primary');

	const icon = svg(color, addBackofficeLogo);
