...
test('Returns FILE for m2o relations to backoffice_files', () => {
	const fieldsStore = useFieldsStore();
	...
	(relationsStore.getRelationsForField as Mock).mockReturnValue([
		{
			collection: 'test_collection',
			field: 'test_fields',
			related_collection: 'backoffice_files',
			meta: {
...
test('Returns O2M', () => {
	...
	expect(getLocalTypeForField('backoffice_files', 'test_field')).toBe('o2m');
});
...
test('Returns TRANSLATIONS for special M2M relations', () => {
	...
	expect(getLocalTypeForField('backoffice_files', 'test_field')).toBe('translations');
});
...
test('Returns FILES for M2M relations to backoffice_files', () => {
	const fieldsStore = useFieldsStore();
	...
	(relationsStore.getRelationsForField as Mock).mockReturnValue([
		{
			collection: 'collection_a_backoffice_files',
			field: 'collection_a_id',
			related_collection: 'collection_a',
			meta: {
				many_collection: 'collection_a_backoffice_files',
				many_field: 'collection_a_id',
				one_collection: 'collection_a',
				one_field: 'relation',
				one_collection_field: null,
				one_allowed_collections: null,
				junction_field: 'backoffice_files_id',
				sort_field: null,
				one_deselect_action: 'nullify',
			},
		},
		{
			collection: 'collection_a_backoffice_files',
			field: 'backoffice_files_id',
			related_collection: 'backoffice_files',
			meta: {
				many_collection: 'collection_a_backoffice_files',
				many_field: 'backoffice_files_id',
				one_collection: 'backoffice_files',
				one_field: null,
				one_collection_field: null,
				one_allowed_collections: null,
