...
const accessibleSystemCollections = {
	backoffice_users: { route: '/users' },
	backoffice_files: { route: '/files' },
	backoffice_dashboards: { route: '/insights' },
	backoffice_activity: { route: '/activity' },
	backoffice_settings: { route: '/settings/project', singleton: true },
	backoffice_collections: { route: '/settings/data-model' },
	backoffice_roles: { route: '/settings/roles' },
	backoffice_presets: { route: '/settings/presets' },
	backoffice_translations: { route: '/settings/translations' },
	backoffice_flows: { route: '/settings/flows' },
} as const;
