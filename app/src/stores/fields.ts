...
import { DeepPartial, Field, FieldRaw, Relation } from '@backoffice/types';
...
/**
 * backoffice_files is a special case. For it to play nice with interfaces/layouts/displays, we need
