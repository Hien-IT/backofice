import type { Panel } from '@backoffice/extensions';
import { isSystemCollection } from '@backoffice/system-data';
import type { Item } from '@backoffice/types';
import { applyOptionsData, getSimpleHash, toArray } from '@backoffice/utils';
...
export const useInsightsStore = defineStore('insightsStore', () => {
	...
	async function hydrate() {
		...
		if (hasPermission('backoffice_dashboards', 'read') && hasPermission('backoffice_panels', 'read')) {
			try {
