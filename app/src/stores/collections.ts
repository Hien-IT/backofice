...
import { Collection as CollectionRaw, DeepPartial, Field } from '@backoffice/types';
import { getCollectionType } from '@backoffice/utils';
...
export const useCollectionsStore = defineStore('collectionsStore', () => {
	...
	/**
	 * All non-system collections that have a meta object, i.e. are configured in Backoffice
	 */
