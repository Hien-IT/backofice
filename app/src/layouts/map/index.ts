import { useCollection, useItems, useSync } from '@backoffice/composables';
import { defineLayout } from '@backoffice/extensions';
import { Field, Filter, GeometryOptions } from '@backoffice/types';
import { getFieldsFromTemplate, mergeFilters } from '@backoffice/utils';
...
export default defineLayout<LayoutOptions, LayoutQuery>({
	...
	setup(props, { emit }) {
		...
		function updateSource() {
			backofficeSource.value = merge({}, backofficeSource.value, {
