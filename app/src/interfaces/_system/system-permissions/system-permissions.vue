...
import { PERMISSION_ACTIONS } from '@backoffice/constants';
import { appAccessMinimalPermissions, isSystemCollection } from '@backoffice/system-data';
import { type Alterations, Filter, Permission, PermissionsAction } from '@backoffice/types';
	...
	async function fetchPermissions() {
		...
		try {
			...
			if (itemId.value !== '+') {
				...
				const response = await api.get(getEndpoint('backoffice_permissions'), {
					params: {
						fields: '*',
						filter,
						page: 0,
