...
/**
 * This file is a modified version of the attaches and image tool from editorjs to work with the Backoffice file manager.
 *
 * We include an uploader to directly use Backoffice file manager, along with a modified version of the attaches and image tools.
 */
