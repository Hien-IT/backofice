...
import { ContentVersion, Field, PrimaryKey, Relation } from '@backoffice/types';
...
if (
	!collection.value.startsWith('backoffice_') &&
	(!relatedCollection.value || !relatedCollection.value.startsWith('backoffice_'))
) {
