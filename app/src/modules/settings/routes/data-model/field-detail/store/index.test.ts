...
describe('Alterations', () => {
	describe('files', () => {
		it('autoGenerateJunctionRelation has changed', () => {
			...
			expect(fieldDetailStore.relations.m2o?.related_collection).toEqual('backoffice_files');
			expect(fieldDetailStore.relations.m2o?.field).toEqual('backoffice_files_id');
