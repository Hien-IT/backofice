...
import { Alterations, Item, Policy } from '@backoffice/types';
...
const policiesField = cloneDeep(fieldsStore.getField('backoffice_roles', 'policies'));
...
policiesField!.meta!.options = {
	...
	filter: {
		'$FOLLOW(backoffice_access,policy)': {
			_none: {
				_and: [
					{
						role: {
