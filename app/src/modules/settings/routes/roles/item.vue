...
import { Role } from '@backoffice/types';
...
<template>
	...
	>
		...
		<template #sidebar>
			...
			<RevisionsSidebarDetail ref="revisionsSidebarDetailRef" collection="backoffice_roles" :primary-key="primaryKey" />
		</template>
