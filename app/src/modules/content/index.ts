import { defineModule } from '@backoffice/extensions';
import { Collection } from '@backoffice/types';
	...
	routes: [
		{
			...
			beforeEnter() {
				...
				const lastAccessedCollection = useLocalStorage<string | null>('backoffice-last-accessed-collection', null);
