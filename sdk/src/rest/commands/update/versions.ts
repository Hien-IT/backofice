import type { BackofficeVersion } from '../../../schema/version.js';
...
export type UpdateContentVersionOutput<
	...
	Item extends object = BackofficeVersion<Schema>,
...
export const updateContentVersions =
	<Schema, const TQuery extends Query<Schema, BackofficeVersion<Schema>>>(
		keys: BackofficeVersion<Schema>['id'][],
		item: NestedPartial<BackofficeVersion<Schema>>,
		query?: TQuery,
...
export const updateContentVersionsBatch =
	<Schema, const TQuery extends Query<Schema, BackofficeVersion<Schema>>>(
		items: NestedPartial<BackofficeVersion<Schema>>[],
		query?: TQuery,
	): RestCommand<UpdateContentVersionOutput<Schema, TQuery>[], Schema> =>
	() => ({
		path: `/versions`,
...
export const updateContentVersion =
	<Schema, const TQuery extends Query<Schema, BackofficeVersion<Schema>>>(
		key: BackofficeVersion<Schema>['id'],
		item: NestedPartial<BackofficeVersion<Schema>>,
		query?: TQuery,
	): RestCommand<UpdateContentVersionOutput<Schema, TQuery>, Schema> =>
	() => {
