import type { BackofficeDashboard } from '../../../schema/dashboard.js';
...
export type UpdateDashboardOutput<
	...
	Item extends object = BackofficeDashboard<Schema>,
...
export const updateDashboards =
	<Schema, const TQuery extends Query<Schema, BackofficeDashboard<Schema>>>(
		keys: BackofficeDashboard<Schema>['id'][],
		item: NestedPartial<BackofficeDashboard<Schema>>,
		query?: TQuery,
...
export const updateDashboardsBatch =
	<Schema, const TQuery extends Query<Schema, BackofficeDashboard<Schema>>>(
		items: NestedPartial<BackofficeDashboard<Schema>>[],
		query?: TQuery,
	): RestCommand<UpdateDashboardOutput<Schema, TQuery>[], Schema> =>
	() => ({
		path: `/dashboards`,
...
export const updateDashboard =
	<Schema, const TQuery extends Query<Schema, BackofficeDashboard<Schema>>>(
		key: BackofficeDashboard<Schema>['id'],
		item: NestedPartial<BackofficeDashboard<Schema>>,
		query?: TQuery,
	): RestCommand<UpdateDashboardOutput<Schema, TQuery>, Schema> =>
	() => {
