import type { BackofficeFolder } from '../../../schema/folder.js';
...
export type UpdateFolderOutput<
	...
	Item extends object = BackofficeFolder<Schema>,
...
export const updateFolders =
	<Schema, const TQuery extends Query<Schema, BackofficeFolder<Schema>>>(
		keys: BackofficeFolder<Schema>['id'][],
		item: NestedPartial<BackofficeFolder<Schema>>,
		query?: TQuery,
...
export const updateFoldersBatch =
	<Schema, const TQuery extends Query<Schema, BackofficeFolder<Schema>>>(
		items: NestedPartial<BackofficeFolder<Schema>>[],
		query?: TQuery,
	): RestCommand<UpdateFolderOutput<Schema, TQuery>[], Schema> =>
	() => ({
		path: `/folders`,
