import type { BackofficeTranslation } from '../../../schema/translation.js';
...
export type UpdateTranslationOutput<
	...
	Item extends object = BackofficeTranslation<Schema>,
...
export const updateTranslations =
	<Schema, const TQuery extends Query<Schema, BackofficeTranslation<Schema>>>(
		keys: BackofficeTranslation<Schema>['id'][],
		item: NestedPartial<BackofficeTranslation<Schema>>,
		query?: TQuery,
...
export const updateTranslationsBatch =
	<Schema, const TQuery extends Query<Schema, BackofficeTranslation<Schema>>>(
		items: NestedPartial<BackofficeTranslation<Schema>>[],
		query?: TQuery,
	): RestCommand<UpdateTranslationOutput<Schema, TQuery>[], Schema> =>
	() => ({
		path: `/translations`,
...
export const updateTranslation =
	<Schema, const TQuery extends Query<Schema, BackofficeTranslation<Schema>>>(
		key: BackofficeTranslation<Schema>['id'],
		item: NestedPartial<BackofficeTranslation<Schema>>,
		query?: TQuery,
	): RestCommand<UpdateTranslationOutput<Schema, TQuery>, Schema> =>
	() => {
