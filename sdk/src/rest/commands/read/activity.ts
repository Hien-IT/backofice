import type { BackofficeActivity } from '../../../schema/activity.js';
...
export type ReadActivityOutput<
	...
	Item extends object = BackofficeActivity<Schema>,
...
export const readActivities =
	<Schema, const TQuery extends Query<Schema, BackofficeActivity<Schema>>>(
		query?: TQuery,
...
export const readActivity =
	<Schema, const TQuery extends Query<Schema, BackofficeActivity<Schema>>>(
		key: BackofficeActivity<Schema>['id'],
		query?: TQuery,
	): RestCommand<ReadActivityOutput<Schema, TQuery>, Schema> =>
	() => {
