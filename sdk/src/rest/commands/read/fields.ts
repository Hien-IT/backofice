...
export type ReadFieldOutput<Schema, Item extends object = BackofficeField<Schema>> = ApplyQueryFields<Schema, Item, '*'>;
...
export const readFieldsByCollection =
	<Schema>(collection: BackofficeField<Schema>['collection']): RestCommand<ReadFieldOutput<Schema>[], Schema> =>
	() => {
