import type {
	...
	BackofficeDeploymentProject,
	BackofficeDeploymentRun,
...
export type ReadDeploymentProjectOutput<
	Schema,
	TQuery extends Query<Schema, Item>,
	Item extends object = BackofficeDeploymentProject<Schema>,
> = ApplyQueryFields<Schema, Item, TQuery['fields']>;

export type ReadDeploymentRunOutput<
	Schema,
	TQuery extends Query<Schema, Item>,
	Item extends object = BackofficeDeploymentRun<Schema>,
> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
...
export const readDeploymentProject =
	<Schema, const TQuery extends Query<Schema, BackofficeDeploymentProject<Schema>>>(
		provider: string,
		projectId: string,
		query?: TQuery,
...
export const readDeploymentRun =
	<Schema, const TQuery extends Query<Schema, BackofficeDeploymentRun<Schema>>>(
		provider: string,
		runId: string,
		query?: TQuery,
