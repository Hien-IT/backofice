...
/**
 * Creates a client to communicate with the Backoffice REST API.
 *
 * @returns A Backoffice REST client.
 */
export const rest = (config: Partial<RestConfig> = {}) => {
	return <Schema>(client: BackofficeClient<Schema>): RestClient<Schema> => {
