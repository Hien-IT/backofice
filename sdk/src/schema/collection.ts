import type { BackofficeField, MergeCoreCollection, NestedPartial } from '../index.js';

export type BackofficeCollection<Schema = any> = {
	...
	schema:
		...
		| null;
	fields?: NestedPartial<BackofficeField<Schema>>[];
};
