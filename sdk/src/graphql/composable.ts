...
/**
 * Creates a client to communicate with Backoffice GraphQL.
 *
 * @returns A Backoffice GraphQL client.
 */
export const graphql = (config: Partial<GraphqlConfig> = {}) => {
	return <Schema>(client: BackofficeClient<Schema>): GraphqlClient<Schema> => {
