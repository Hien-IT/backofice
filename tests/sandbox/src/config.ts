...
const backofficeConfig = {
	...
	ADMIN_PASSWORD: 'pw',
	ADMIN_TOKEN: 'admin',
	SECRET: 'backoffice-test',
	TELEMETRY: 'false',
	CONFIG_PATH: join(backofficeFolder, '.env'), // Override to non existent file so process envs aren't overwritten by file envs
...
const minio = {
	...
	STORAGE_MINIO_KEY: 'backoffice',
	STORAGE_MINIO_SECRET: 'miniosecret',
	STORAGE_MINIO_BUCKET: 'backoffice-blackbox-test',
...
const maildev = {
	...
	EMAIL_SMTP_USER: 'admin@backoffice.io',
