...
import type { DatabaseClient, DeepPartial } from '@backoffice/types';
import chalk from 'chalk';
import { merge } from 'lodash-es';
import { type Env, getEnv } from './config.js';
import { backofficeFolder } from './find-backoffice.js';
...
export const apiFolder = join(backofficeFolder, 'api');
export const appFolder = join(backofficeFolder, 'app');
