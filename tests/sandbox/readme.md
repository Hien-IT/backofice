# Backoffice Api Sandbox 🛠️

Utility functions for quickly spinning up and down instances of backoffice for usage such as testing or development.
...
CLI for spinning up backoffice sandboxes for testing and development purposes
...
Options:
  ...
  -b, --build                  Rebuild backoffice from source
  -d, --dev                    Start backoffice in developer mode. Not compatible with build
  ...
  -i, --instances <instances>  Horizontally scale backoffice to a given number of instances (default: "1")
