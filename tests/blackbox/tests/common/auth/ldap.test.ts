/**
 * Backoffice LDAP Authentication Integration Tests
 *
 * These tests validate Backoffice's LDAP authentication integration through the API.
 ...
 * and test Backoffice's LDAP integration as a whole, not the ldapts library itself.
 */
