...
export function generateHash(stringToHash) {
	const buffer = 'string';
	const argon2HashConfigOptions = { test: 'test', associatedData: buffer }; // Disallow the HASH_RAW option, see https://github.com/backoffice/backoffice/discussions/7670#discussioncomment-1255805
