...
import { createUser, type BackofficeClient, type RestClient } from '@backoffice/sdk';
import { type Permission, type Snapshot } from '@backoffice/types';
...
export async function generateScopedUser(
	api: BackofficeClient<unknown> & RestClient<unknown>,
	snapshot: Snapshot,
