...
if (options.extras?.saml) {
	describe('/auth/login/saml', () => {
		...
		describe('POST /acs', () => {
			...
			// 	test('returns backoffice refresh token in JSON', async () => {
			// 		// Action
			...
			// 	test('returns backoffice refresh token in cookie', async () => {
			// 		// Action
			...
			// 		// Assert
			// 		expect(cookies).toMatch(/backoffice_session_token/);
			// 	});
			// });
