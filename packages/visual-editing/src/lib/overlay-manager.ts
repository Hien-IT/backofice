export class OverlayManager {
	private static readonly CSS_VAR_Z_INDEX = '--backoffice-visual-editing--overlay--z-index';
	private static readonly CSS_VAR_BORDER_SPACING = '--backoffice-visual-editing--rect--border-spacing';
	private static readonly CSS_VAR_BORDER_WIDTH = '--backoffice-visual-editing--rect--border-width';
	private static readonly CSS_VAR_BORDER_COLOR = '--backoffice-visual-editing--rect--border-color';
	private static readonly CSS_VAR_BORDER_RADIUS = '--backoffice-visual-editing--rect--border-radius';
	private static readonly CSS_VAR_HOVER_OPACITY = '--backoffice-visual-editing--rect-hover--opacity';
	private static readonly CSS_VAR_HIGHLIGHT_OPACITY = '--backoffice-visual-editing--rect-highlight--opacity';
	private static readonly CSS_VAR_ACTIONS_GAP = '--backoffice-visual-editing--actions--gap';
	private static readonly CSS_VAR_BUTTON_WIDTH = '--backoffice-visual-editing--edit-btn--width';
	private static readonly CSS_VAR_BUTTON_HEIGHT = '--backoffice-visual-editing--edit-btn--height';
	private static readonly CSS_VAR_BUTTON_RADIUS = '--backoffice-visual-editing--edit-btn--radius';
	private static readonly CSS_VAR_EDIT_BUTTON_BG_COLOR = '--backoffice-visual-editing--edit-btn--bg-color';
	private static readonly CSS_VAR_EDIT_BUTTON_ICON_BG_IMAGE = '--backoffice-visual-editing--edit-btn--icon-bg-image';
	private static readonly CSS_VAR_EDIT_BUTTON_ICON_BG_SIZE = '--backoffice-visual-editing--edit-btn--icon-bg-size';
	private static readonly CSS_VAR_AI_BUTTON_BG_COLOR = '--backoffice-visual-editing--ai-btn--bg-color';
	private static readonly CSS_VAR_AI_BUTTON_ICON_BG_IMAGE = '--backoffice-visual-editing--ai-btn--icon-bg-image';
	private static readonly CSS_VAR_AI_BUTTON_ICON_BG_SIZE = '--backoffice-visual-editing--ai-btn--icon-bg-size';
	...
	private static readonly OVERLAY_ID = 'backoffice-visual-editing';
	private static readonly STYLE_ID = 'backoffice-visual-editing-style';

	static readonly CONTAINER_RECT_CLASS_NAME = 'backoffice-visual-editing-overlay';
	static readonly RECT_CLASS_NAME = 'backoffice-visual-editing-rect';
	static readonly RECT_HIGHLIGHT_CLASS_NAME = 'backoffice-visual-editing-rect-highlight';
	static readonly RECT_HIGHLIGHT_ACTIVE_CLASS_NAME = 'backoffice-visual-editing-rect-highlight-active';
	static readonly RECT_PARENT_HOVER_CLASS_NAME = 'backoffice-visual-editing-rect-parent-hover';
	static readonly RECT_HOVER_CLASS_NAME = 'backoffice-visual-editing-rect-hover';
	static readonly RECT_INNER_CLASS_NAME = 'backoffice-visual-editing-rect-inner';
	static readonly RECT_BUTTON_CLASS_NAME = 'backoffice-visual-editing-button';
	static readonly RECT_EDIT_BUTTON_CLASS_NAME = 'backoffice-visual-editing-edit-button';
	static readonly RECT_AI_BUTTON_CLASS_NAME = 'backoffice-visual-editing-ai-button';
