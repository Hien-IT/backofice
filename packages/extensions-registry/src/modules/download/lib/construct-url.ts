 ...
 * extension version from the Backoffice extensions registry. It supports both
 ...
 * console.log(downloadUrl.href); // 'https://registry.backoffice.io/download/extension-v1.0.0'
 *
 * // Download with sandbox mode enabled
 * const sandboxUrl = constructUrl('extension-v1.0.0', true);
 * console.log(sandboxUrl.href); // 'https://registry.backoffice.io/download/extension-v1.0.0?sandbox=true'
 *
