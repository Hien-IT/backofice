/**
 * Variables in the environment that Backoffice will read as configuration
 */
export const BACKOFFICE_VARIABLES = [
	// general
	'CONFIG_PATH',
	'HOST',
	'PORT',
...
/**
 * Variables in the environment that Backoffice will read as configuration in RegExp format
 */
export const BACKOFFICE_VARIABLES_REGEX: RegExp[] = BACKOFFICE_VARIABLES.map((name) => new RegExp(`^${name}$`));
