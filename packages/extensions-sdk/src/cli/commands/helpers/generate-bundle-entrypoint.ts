...
import { API_EXTENSION_TYPES, APP_EXTENSION_TYPES, HYBRID_EXTENSION_TYPES } from '@backoffice/constants';
import type { ExtensionOptionsBundleEntry } from '@backoffice/extensions';
import { isIn, isTypeIn, pluralize } from '@backoffice/utils';
