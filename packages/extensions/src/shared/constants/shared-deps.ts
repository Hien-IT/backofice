 ...
 */
export const APP_SHARED_DEPS = ['@backoffice/extensions-sdk', 'vue', 'vue-router', 'vue-i18n', 'pinia'] as const;

/**
 * Dependencies that we guarantee are available in the node_modules of the API when API extensions
 * are used. The `backoffice:*` extensions are virtual entrypoints available in the sandbox
 */
export const API_SHARED_DEPS = ['backoffice', 'backoffice:api'] as const;
