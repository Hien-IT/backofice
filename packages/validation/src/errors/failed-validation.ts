import { createError, type BackofficeErrorConstructor } from '@backoffice/errors';
import type { ClientFilterOperator } from '@backoffice/types';
...
export const FailedValidationError: BackofficeErrorConstructor<FailedValidationErrorExtensions> =
