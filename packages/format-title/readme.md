...
```shell
npm install @backoffice/format-title
```
...
[LICENSE](https://github.com/backoffice/backoffice/blob/main/packages/format-title/license) file for more information.
